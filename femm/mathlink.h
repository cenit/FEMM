/*************************************************************************
        ...
        Copyright 1986 through 2002 by Wolfram Research Inc.
        All rights reserved
...
#if WINDOWS_MATHLINK || __i386 || __i386__ || i386 || _M_IX86 || __alpha || __alpha__ || alpha
...
#else /* !(GENERATINGCFM && GENERATING68K && !DIRECT_TEXT_CALLS) */
...
#endif /* GENERATINGCFM && GENERATING68K && !DIRECT_TEXT_CALLS */
#else /* !MACINTOSH_MATHLINK */
typedef dispatch_procptr_mlnet dispatch_function_mlnet;
#define call_num_dispatch(num_dispatch, selector, dptr, sptr, countp) \
  ((*(num_dispatch))((selector), (dptr), (sptr), (countp)))
...
enum { MLTerminateMessage = 1,
  MLInterruptMessage,
  MLAbortMessage,
  MLEndPacketMessage,
  MLSynchronizeMessage,
  MLImDyingMessage,
  MLWaitingAcknowledgment,
  MLMarkTopLevelMessage,
  MLFirstUserMessage = 128,
...
enum { MLAlertFunction = 1,
  MLRequestFunction,
  MLConfirmFunction,
  MLRequestArgvFunction,
  MLRequestToInteractFunction };
...
MLDDEFN(mldlg_result, MLDontPermit_darwin, (MLEnvironment ep, mldlg_result wait_for_permission));
